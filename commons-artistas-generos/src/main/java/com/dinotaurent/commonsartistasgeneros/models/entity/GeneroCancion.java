...
public class GeneroCancion {
    ...
    @JsonIgnoreProperties(value = {"generoCancion"})
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof GeneroCancion gC)) {
            return false;
        }
        return this.cancionId != null && this.cancionId.equals(gC.getCancionId());
    }
